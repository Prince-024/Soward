...
class SelfRoleOptionSelecter(discord.ui.View):
    ...
    @discord.ui.select(placeholder="Please select a selfrole option.", options=[
        SelectOption(label='Reactions', description="Users will react to get roles.", vajlue='reaction'),
        SelectOption(label='Dropdowns', description="Users will select roles from a dropdown menu like this!", vajlue='dropdown'),
        SelectOption(label='Buttons', description="Users will get roles by clicking buttons.", vajlue='button')
    ])
